...
public class Product {
    ...
    public String toString() {
        return String.format("Product{id=%d, name='%s', UPC='%s', manufacturer='%s', price=%.2f, shelfLife=%d, quantity=%d}",
    ...
    public static void main(String[] args) {
        ...
        manager.addProduct(new Product(1, "Молоко", "123456", "Простоквашино", 2.5, 7, 100));
        manager.addProduct(new Product(2, "Хлеб", "654321", "Домашний", 1.2, 3, 50));
        manager.addProduct(new Product(3, "Молоко", "789012", "Савушкин", 2.0, 10, 80));
        manager.addProduct(new Product(4, "Сыр", "345678", "Беллакт", 5.5, 30, 40));
